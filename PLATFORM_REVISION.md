...
- **Витрина:** карточка бизнеса по slug (`/biz/[slug]`, `/u/[slug]`); контакты, портфолио, модалки — по текущей реализации.
...
3. **Почистить useEffect-зависимости:** в PartnershipPageClient, PriceUploadModal, RequestsPageClient и др. — чтобы избежать устаревших замыканий и лишних ререндеров.
