...
/** Убрать одиночные единицы (ед. изм.): "Пекинская капуста шт" → "Пекинская капуста", "Лук порей шт Лист" → "Лук порей Лист". Не трогать "1 кг". Kr = OCR кг. */
...
const UNIT_COLUMN_IGNORE = /^(кг|г|гр|л|мл|шт|уп|упак|пач|пуч|кор|ящ|т|м|ед|к|kr)\.?\s*_?\s*$/i
...
/** Строка содержит только единицу измерения (ед. изм. — игнорируем). Kr = OCR-ошибка кг. */
const UNIT_ONLY = /^(кг|г|гр|л|мл|шт|уп|упак|пач|пуч|кор|ящ|т|м|ед|к|kr)\.?\s*_?\s*$/i
